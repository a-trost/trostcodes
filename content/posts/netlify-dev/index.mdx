...
![Terminal after running the Gatsby CLI](/images/netlify-dev/netlify-dev1.png)
...
![Terminal after running netlify init, asking if we're sure we want to deploy without Git](/images/netlify-dev/netlify-dev2.png)
...
![Terminal after successfully initializing Netlify on this project](/images/netlify-dev/netlify-dev3.png)

If you head to your Netlify.com admin panel, you’ll see that Netlify is aware of our project. Great!

![The Netlify admin panel showing our site](/images/netlify-dev/netlify-dev4.png)
...
![Terminal: The success message after running Netlify Dev](/images/netlify-dev/netlify-dev5.png)
...
![Screenshot of a basic Gatsby blog](/images/netlify-dev/netlify-dev6.png)
...
![Edited gatsby-config.js file](/images/netlify-dev/netlify-dev7.png)

Hit save and almost instantly anyone viewing that link will see the update.

![Screenshot of our updated Gatsby blog](/images/netlify-dev/netlify-dev8.png)
